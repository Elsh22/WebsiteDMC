...
function GalleryPhoto() {
  ...
  const getImg = (imgSrc) => {
    ...
    setModel(true);
    document.body.style.overflow = 'hidden'; // Disable scrolling on the main page when the modal is open
  };
  ...
  return (
    <>
      <div className={model ? 'model open' : 'model'}>
        ...
        <i className="fa fa-close close-icon" onClick={() => setModel(false)}></i>
      </div>
